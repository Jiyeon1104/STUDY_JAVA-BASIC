...
<main class="form-signin">
  ...
  <form action="joincheckclass.jsp">
    ...
    <div class="form-floating">
      <input name="unm" type="text" class="form-control" id="floatingInput" placeholder="이름을 입력하세요">
    ...
    <div class="form-floating">
      <input name="upw" type="password" class="form-control" id="floatingInput" placeholder="암호를 입력하세요">
